...
const electricBikes = [
  { id: 1, name: "Thunder-E 500", price: "₹1.85L", range: "180km", accel: "3.2s", rating: 4.9, reviews: "2.1k", type: "Sport", year: 2024, img: bikeMain, desc: "A high-performance street machine for thrill-seekers.", guidance: "Perfect for weekend rides." },
  { id: 2, name: "Volt-X Street", price: "₹1.45L", range: "150km", accel: "4.5s", rating: 4.7, reviews: "1.2k", type: "City", year: 2024, img: bike2, desc: "The perfect urban commuter bike. Lightweight and agile.", guidance: "Ideal for daily city commutes." },
  { id: 3, name: "Nexus Phantom", price: "₹2.10L", range: "220km", accel: "2.9s", rating: 5.0, reviews: "850", type: "Touring", year: 2024, img: "https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?auto=format&fit=crop&q=80&w=800", desc: "Flagship touring bike. Premium comfort.", guidance: "Best for road trips." },
  { id: 4, name: "V-Moto Elite", price: "₹4.50L", range: "250km", accel: "2.5s", rating: 5.0, reviews: "Exclusive", type: "Superbike", year: 2025, img: "https://images.unsplash.com/photo-1614162692292-7ac56d7f7f1e?auto=format&fit=crop&q=80&w=800", desc: "Neural motor control and carbon frame.", guidance: "Elite performance." }
];
...
const Bikes = () => {
  ...
  const handleBookNow = (bike) => {
    // PASSING THE BIKE DATA TO BOOKING PAGE
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-20 items-center justify-between glass p-8 rounded-[2.5rem] border-white/5 sticky top-24 z-40 bg-black/80 backdrop-blur-xl">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            {categories.map(cat => (
              <button key={cat} onClick={() => setFilter(cat)} className={`px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-widest transition-all ${filter === cat ? 'bg-primary text-white' : 'bg-white/5 border border-white/10 hover:border-white/20'}`}>
                {cat}
              </button>
            ))}
          </div>
              ...
              <div className="p-10 flex flex-col flex-grow text-white">
                <div className="flex justify-between items-start mb-6">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-3xl font-black italic text-white">{bike.price}</p>
                  </div>
                </div>
                ...
                <div className="mt-auto space-y-4 pt-8 border-t border-white/5">
                  ...
                  <button onClick={() => navigate('/garage')} className="w-full py-4 border border-primary/20 hover:border-primary/50 rounded-full font-black text-[10px] tracking-[0.2em] uppercase transition-all flex items-center justify-center gap-3 bg-primary/5 hover:bg-primary/10 text-white">
