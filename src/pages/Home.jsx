...
import { ArrowRight, Wrench, ShieldCheck, Zap, Gauge, Star, Play, MapPin, CheckCircle2 } from 'lucide-react';
...
const Home = () => {
  ...
  return (
    <div className="bg-black text-white selection:bg-primary">
      ...
      {/* BRAND HEADER SECTION - Logo & Detailed Description */}
      <section className="pt-40 pb-20 px-6 md:px-20 bg-gradient-to-b from-primary/10 to-black relative overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-32">
            <div className="reveal flex-1">
              <div className="flex items-center gap-6 mb-10 group">
                <div className="w-20 h-20 md:w-24 md:h-24 rounded-[2rem] overflow-hidden rotate-3 group-hover:rotate-6 transition-transform duration-500 shadow-[0_0_40px_rgba(0,122,255,0.4)] border border-white/10 bg-white">
                   <img src={logoImg} alt="Velocity Motors Logo" className="w-full h-full object-contain p-2" />
                </div>
                <div className="flex flex-col">
                  <span className="outfit text-5xl md:text-6xl font-black tracking-tighter leading-none text-white">VELOCITY</span>
                  <span className="text-sm md:text-lg font-bold tracking-[0.5em] text-primary uppercase leading-none mt-2">MOTORS</span>
                </div>
              </div>
              <h2 className="outfit text-5xl md:text-8xl font-black italic tracking-tighter uppercase leading-[0.9] mb-10">
                THE <span className="gradient-text">FUTURE</span> <br /> IS ELECTRIC.
              </h2>
              ...
              <div className="flex flex-wrap gap-6">
                 <div className="flex items-center gap-4 glass px-8 py-4 rounded-[2rem] border-primary/20 bg-primary/5">
                    <MapPin className="text-primary" size={24} />
                    <div className="flex flex-col">
                       <span className="text-[10px] font-black uppercase tracking-widest text-primary">Location Hub</span>
                       <span className="text-sm font-bold text-white">Matoshri Engineering Centre, Odha</span>
                    </div>
                 </div>
                 <div className="flex items-center gap-4 glass px-8 py-4 rounded-[2rem] border-white/10">
                    ...
                    <div className="flex flex-col">
                       ...
                       <span className="text-sm font-bold text-white">Sales & 24/7 Garage</span>
                    </div>
                 </div>
              </div>
            </div>
            ...
            <div className="reveal lg:w-1/3 w-full bg-[#080808] border border-white/5 p-12 rounded-[4rem] relative group mt-10 lg:mt-0 shadow-2xl">
               ...
               <p className="text-gray-500 text-lg italic leading-relaxed mb-10">
                 Explore our exclusive collection of 30+ electric cars and premium two-wheelers. Experience the power, the silence, and the thrill of the electric era at our Nashik Innovation Hub.
               </p>
               <button onClick={() => navigate('/about')} className="group flex items-center gap-4 text-white font-black text-xs uppercase tracking-[0.2em] hover:text-primary transition-all">
                  <span>COMPANY MANIFESTO</span>
                  <div className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center group-hover:border-primary group-hover:translate-x-2 transition-all">
                    <ArrowRight size={16} />
                  </div>
               </button>
            </div>
      ...
      <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <h1 className="outfit text-7xl md:text-[12vw] font-black italic tracking-tighter leading-none mb-8 reveal uppercase">
          ...
          <div className="reveal flex flex-col sm:flex-row gap-6 justify-center items-center">
            <button
              ...
              className="btn-primary px-12 py-6 text-xl shadow-[0_20px_50px_rgba(0,122,255,0.3)] group"
            >
              <span>GET STARTED</span>
              <ArrowRight className="group-hover:translate-x-2 transition-transform" />
            </button>
            <div className="flex items-center gap-8 ml-0 sm:ml-10 border-l border-white/20 pl-8 text-left">
               <div>
               ...
               <div>
                  <p className="text-2xl font-black italic">600km</p>
      ...
      {/* SECTION 2: BENTO GRID - WHY VELOCITY? */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            <div className="lg:col-span-8 reveal relative aspect-video md:h-[500px] rounded-[4rem] overflow-hidden group">
               ...
               <div className="absolute bottom-12 left-12">
                  <h3 className="outfit text-4xl md:text-6xl font-black italic uppercase tracking-tighter mb-4">Mastering <span className="text-primary">Voltage</span></h3>
                  <p className="text-gray-400 italic max-w-md text-lg">Our V-Core technology delivers 98% efficiency, ensuring every watt is turned into pure speed.</p>
               </div>
            </div>
            ...
            <div className="lg:col-span-4 reveal bg-[#0a0a0a] border border-white/5 p-12 rounded-[4rem] flex flex-col justify-between hover:border-primary/30 transition-colors group">
               ...
               <div>
                  <h4 className="outfit text-3xl font-black italic uppercase mb-4">Hyper-Charging</h4>
            ...
            <div className="lg:col-span-8 reveal relative aspect-video md:h-[400px] rounded-[4rem] overflow-hidden bg-primary/10 border border-primary/20 p-12 flex items-center justify-around text-center md:text-left">
               <div className="flex flex-col items-center">
                  <p className="outfit text-6xl md:text-[8vw] font-black italic gradient-text">50+</p>
      ...
      {/* SECTION 3: THE MASTER GARAGE PREVIEW */}
      <section className="py-32 px-6 md:px-20 bg-[#050505] overflow-hidden border-y border-white/5">
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="reveal">
            ...
            <h2 className="outfit text-5xl md:text-8xl font-black italic tracking-tighter leading-none mb-10 uppercase">
            ...
            <button onClick={() => navigate('/garage')} className="btn-primary px-12 group">
          ...
          <div className="reveal relative">
             <div className="aspect-square rounded-[5rem] overflow-hidden border border-white/5 relative group shadow-2xl">
                <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=1974" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-[2s]" alt="Jayesh Gangurde" />
      ...
      <section className="py-48 bg-black text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <h2 className="reveal outfit text-6xl md:text-[12vw] font-black italic tracking-tighter leading-[0.8] mb-16 uppercase text-white">
            THE <span className="gradient-text">ELECTRIC</span> <br /> REVOLUTION
          </h2>
          <div className="reveal flex flex-col md:flex-row justify-center gap-10">
            <button onClick={() => navigate('/book')} className="btn-primary px-20 py-8 text-3xl group shadow-[0_30px_60px_rgba(0,122,255,0.4)]">
